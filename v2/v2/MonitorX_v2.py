...
class SerialMonitor:
    ...
    def init_ui(self):
        ctk.CTkLabel(self.root, text="PORT", font=("impack", 20, "bold")).place(
            x=30, y=0
        )
        ctk.CTkLabel(self.root, text="BAUDRATE", font=("impack", 20, "bold")).place(
            x=320, y=0
        )
        ...
        ToolTip(
            self.combo_com_port,
            msg=" type custom com port number\n or path address in the window",
            bg="grey",
            fg="white",
        )
        ...
        self.lbl_prefix.place(x=60, y=65)
        ...
        self.file_suffix_entry.place(x=185, y=65)
        ctk.CTkLabel(self.root, text=".csv").place(x=330, y=65)
        ...
        self.start_stop_button.place(x=10, y=100)
        ...
        self.help_btn.place(x=360, y=100)
        ...
        self.setting_btn.place(x=200, y=100)

        self.status_label = ctk.CTkLabel(self.root, text="Monitoring Console")
        self.status_label.place(x=20, y=138)
        ...
        self.data_monitor = ctk.CTkTextbox(
            self.root,
            width=430,
        ...
        self.data_monitor.place(x=10, y=310)  # Adjust the coordinates as needed
    ...
    def read_serial_data(self):
        if self.monitoring and self.serial_port and self.serial_port.is_open:
            ...
            self.update_output()
            self.update_data_monitor(data)  # Update data_monitor with data
    ...
    def update_data_monitor(self, data):
        self.data_monitor.configure(state=ctk.NORMAL)  # Enable editing
        self.data_monitor.insert(ctk.END, data.decode())  # Append data
        self.data_monitor.configure(state=ctk.DISABLED)  # Disable editing
        self.data_monitor.see(ctk.END)  # Scroll to the end
